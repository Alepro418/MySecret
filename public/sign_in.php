...
<body translate="no">
    ...
    <main class="container my-5 py-3">
        <section class="login-form-section mb-5">
            <h2 class="text-center mb-4 mysecret-section-title">Inicia Sesión en MySecret</h2>
    ...
    <div class="mb-3">
        <label for="loginEmail" class="form-label mysecret-form-label">Correo Electrónico</label>
    ...
    <div class="mb-3">
        <label for="loginPassword" class="form-label mysecret-form-label">Contraseña</label>
        <div class="password-input-wrapper"> <input type="password" class="form-control mysecret-form-control password-input" id="password" name="password" placeholder="Tu contraseña" required>
            <i class="bi bi-eye-fill password-toggle-icon" id="togglePassword"></i> </div>
    </div>
    <div class="mb-3 form-check">
        <input type="checkbox" class="form-check-input mysecret-checkbox" id="rememberMe">
        <label class="form-check-label mysecret-form-label" for="rememberMe">Recuérdame</label>
    </div>
    ...
    <p class="text-center mt-3">
        <a href="#" class="mysecret-link-text">¿Olvidaste tu contraseña?</a>
    </p>
    <p class="text-center mt-3 mysecret-medium-gray">
        ¿No tienes una cuenta? <a href="sign_up.html" class="mysecret-link-text">Regístrate aquí</a>
    </p>
</form>
                        </div>
                    </div>
