...
<body translate="no">
    ...
    <main class="container my-5 py-3">
        <section class="registration-form-section mb-5">
            <h2 class="text-center mb-4 mysecret-section-title">Únete a MySecret</h2>
                    ...
                    <div class="card mysecret-card p-4">
                        <div class="card-body">
                            <form action="../src/processes/register_user.php" method="post">
                                <div class="mb-3">
                                    <label for="username" class="form-label mysecret-form-label">Nombre de Usuario</label>
                                    <input type="text" class="form-control mysecret-form-control" id="username" name="username" placeholder="Elige un nombre de usuario" required>
                                </div>
                                <div class="mb-3">
                                    <label for="email" class="form-label mysecret-form-label">Correo Electrónico</label>
                                    <input type="email" class="form-control mysecret-form-control" id="email" name="email"  placeholder="tu@ejemplo.com" required>
                                </div>
                                <div class="mb-3">
                                    <label for="password" class="form-label mysecret-form-label">Contraseña</label>
                                ...
                                <div class="mb-3">
                                    <label for="confirmPassword" class="form-label mysecret-form-label">Confirmar Contraseña</label>
                                    <div class="password-input-wrapper">
                                        <input type="password" class="form-control mysecret-form-control password-input" id="confirmPassword" name="confirmPassword" placeholder="Repite tu contraseña" required>
                                ...
                                <div class="mb-4">
                                    <label class="form-label mysecret-form-label d-block mb-2">Quiero unirme como:</label>
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label mysecret-form-label" for="roleCreator">
                                            <i class="bi bi-gem me-1"></i> Creador
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                ...
                                <div class="mb-3 form-check">
                                    ...
                                    <label class="form-check-label mysecret-form-label" for="termsCheck">Acepto los <a href="#" class="mysecret-link-text">Términos de Servicio</a> y la <a href="#" class="mysecret-link-text">Política de Privacidad</a>.</label>
                                </div>
                                <div class="d-grid gap-2">
                                    <button type="submit" class="btn mysecret-btn-primary btn-lg mt-3">
                                        <i class="bi bi-person-plus-fill me-2"></i>Registrarme
                                    </button>
                                </div>
                                <p class="text-center mt-3 mysecret-medium-gray">¿Ya tienes una cuenta? <a href="sign_in.html" class="mysecret-link-text">Inicia Sesión aquí</a></p>
                            </form>
                        </div>
                    </div>
                </div>
