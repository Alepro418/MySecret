        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link mysecret-nav-link active" aria-current="page" href="creator_profile.php"><i class="bi bi-person-circle me-2"></i>My profile</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <a href="creator_profile.php">
                        <li class="nav-item">
                            <img src="Assets/Test_1.jpg" alt="Creator Avatar" class="mysecret-profile-avatar-2 img-fluid" style="width: 50px; height: 50px; border-radius: 50%; border: 0.5px solid #ffc107; object-fit: cover;">
                        </li>
                    </a>
                </ul>
            </div>
