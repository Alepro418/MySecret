...
<head>
    ...
    <title>MySecret - Preferencias de Notificación</title>
    ...
    <style>
        body {
            background-color: #1a1a1a; /* Fondo oscuro similar al tema de MySecret */
        ...
        .mysecret-card {
            background-color: #212529; /* Fondo de tarjeta más oscuro */
            color: white;
            border: none;
        ...
        .mysecret-form-check-input:checked {
            background-color: #ffc107; /* Dorado para checkboxes seleccionados */
            border-color: #ffc107;
        }
        .mysecret-btn-primary {
            background-color: #ffc107; /* Botón primario dorado */
            border-color: #ffc107;
            color: #212529; /* Texto oscuro en botón dorado */
            font-weight: bold;
        }
        .mysecret-btn-primary:hover {
            background-color: #e0a800; /* Dorado más oscuro al pasar el ratón */
            border-color: #e0a800;
        }
        /* CAMBIO AQUI: Hacemos que las etiquetas sean más claras */
        .form-check-label {
            color: #ffffff; /* Blanco puro para mayor claridad */
            /* O podrías probar con un dorado brillante si quieres que destaquen más: */
            /* color: #ffea00; */
        }
...
<body>
    <nav class="navbar navbar-expand-lg mysecret-navbar py-3">
        <div class="container-fluid">
            ...
            <a class="navbar-brand mysecret-logo me-auto text-white" href="#">MySecret</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <a href="creator_profile.php">
                        <li class="nav-item">
                            <img src="Assets/Test_1.jpg" alt="Creator Avatar" class="mysecret-profile-avatar-2 img-fluid">
                        </li>
                    </a>
                </ul>
            </div>
