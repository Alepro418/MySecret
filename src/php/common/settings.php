            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                <div class="col">
                    <div class="card mysecret-setting-card h-100">
                        ...
                        <a href="edit_profile.php" class="btn mysecret-btn-outline mt-3">Ir a Editar Perfil</a>
                    </div>
                </div>
                <div class="col">
                    <div class="card mysecret-setting-card h-100">
                ...
                <div class="col">
                    <div class="card mysecret-setting-card h-100">
                        ...
                        <a href="my_subscriptions.php" class="btn mysecret-btn-outline mt-3">Ver Suscripciones</a>
                    </div>
                </div>
                <div class="col">
                    <div class="card mysecret-setting-card h-100">
