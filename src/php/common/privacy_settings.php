...
<head>
    ...
    <title>MySecret - Configuración de Privacidad</title>
    ...
    <main class="container my-5 py-3">
        <section class="mb-5">
            ...
            <div class="card p-4 mb-4 mysecret-setting-card">
                ...
                <small class="text-muted">Si está desactivado, solo tus suscriptores y usuarios aprobados podrán ver tu perfil completo.</small>
            </div>
