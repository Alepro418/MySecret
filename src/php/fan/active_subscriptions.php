...
<head>
    ...
    <style>
        ...
        /* Custom style for the centered empty state div */
        .empty-subscriptions-message {
            ...
            padding-top: 70px;
            background-color: transparent; /* Optional: give it a background like the cards */
            border-radius: 8px;
            border: 1px solid transparent;
        }

        /* If you want it centered vertically in the viewport, you'd need more complex CSS,
           but for centering within its current flow, mx-auto is sufficient. */
    </style>
</head>
<body>
    ...
    <main class="container my-5 py-3">
        ...
        <section class="mb-5">
            ...
            <div class="col-12 mt-4">
                <div class="empty-subscriptions-message">
