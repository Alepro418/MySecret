...
<head>
    ...
    <style>
        ...
        /* Specific styles for Download Data page */
        .mysecret-data-download-card {
            background-color: #212529;
            color: white;
            border-radius: 8px;
            padding: 40px;
        ...
        .mysecret-data-download-card h2 {
            color: #ffc107;
            margin-bottom: 25px;
            font-family: 'Playfair Display', serif;
        }
        .mysecret-data-download-card p {
            font-size: 1.1rem;
            line-height: 1.6;
            margin-bottom: 30px;
            color: #e0e0e0;
        }
        .mysecret-data-download-card .btn {
            font-size: 1.1rem;
            padding: 12px 30px;
        }
    </style>
